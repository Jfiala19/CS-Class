...
rules = "\nEach round you and the dealer will take turns drawing cards trying to get a hand worth 21. Cards 2-10 are worth their face value, and all face cards are worth ten except aces, which are worth 1 or 11. The dealer's aces will count high for his first two draws, and then drop low along with any newly drawn aces. You will go first, drawing more cards until you bust, hit 21, or stay. After that the dealer will draw until they bust, hit 21, or beat your hand. A win for you pays 3 to 2. You have $100 to start in your bank."
